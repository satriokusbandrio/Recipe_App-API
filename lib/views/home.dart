          ...
          Container(
            ...
            decoration: BoxDecoration(
                gradient: LinearGradient(
                    colors: [
                  const Color(0xff00b368),
                  const Color(0xff00894f)
                ],
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    "Masukkan bahan,Kami cari resep terbaiknya!",
                    style: TextStyle(
                        fontSize: 15,
                        color: Colors.white,
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(8),
                                  gradient: LinearGradient(
                                      colors: [
                                    const Color(0xffc1d500),
                                    const Color(0xffd4d001)
                                  ],
                                      begin: FractionalOffset.topRight,
                                      end: FractionalOffset.bottomLeft)),
